...
{
    protected $fillable = ['source', 'source_id', 'document_routing_event_id', 'pamb_routing_event_id', 'stage_key', 'action_key', 'original_name', 'stored_path', 'mime_type', 'file_size', 'uploaded_by', 'remarks'];
