...
final class DocumentRoutingProfileRegistry
{
    ...
    public function actionProfile(string $sourceKey, bool $directPenro = false): array
    {
        ...
        $actions = [
            ...
            ['key' => 'return_for_correction_cenro_records', 'from' => self::TRANSIT_CENRO_RECORDS, 'to' => self::CENRO_CHIEF, 'event_key' => 'returned_for_correction', 'from_office' => 'CENRO Records Unit', 'to_office' => 'previous accountable sender', 'categories' => [$cenroRecords], 'label' => 'Returned by CENRO Records for Correction', 'action_label' => 'Return for Correction', 'correction' => true, 'receipt_correction_context' => 'cenro_records'],
            ...
            ['key' => 'return_for_correction_penro_records', 'from' => self::TRANSIT_PENRO_RECORDS, 'to' => self::CENRO_RECORDS, 'event_key' => 'returned_for_correction', 'from_office' => 'PENRO Records Unit', 'to_office' => 'previous accountable sender', 'categories' => [$penroRecords], 'label' => 'Returned by PENRO Records for Correction', 'action_label' => 'Return for Correction', 'correction' => true, 'receipt_correction_context' => 'penro_records'],
            // Retained only as the auditable event identity used by the
            // atomic ordinary PENRO Records receipt handoff. It is never a
            // user-executable action.
            ['key' => 'forward_to_office_penro', 'from' => self::PENRO_RECORDS, 'to' => self::TRANSIT_OFFICE_PENRO, 'event_key' => 'forwarded', 'from_office' => 'PENRO Records Unit', 'to_office' => 'Office of the PENRO', 'categories' => [$penroRecords], 'label' => 'Forwarded to Office of the PENRO', 'action_label' => 'Forward to Office of the PENRO', 'internal_only' => true],
