...
final class TargetOfficeNormalizer
{
    ...
    public function normalize(?string $office): array
    {
        ...
        $token = trim($token, '_');
        $aliases = [
            'cenro_baganga' => ['cenro_baganga', 'CENRO Baganga'], 'baganga' => ['cenro_baganga', 'CENRO Baganga'], 'baganga_cenro' => ['cenro_baganga', 'CENRO Baganga'],
            'cenro_manay' => ['cenro_manay', 'CENRO Manay'], 'manay_cenro' => ['cenro_manay', 'CENRO Manay'],
            'cenro_mati' => ['cenro_mati', 'CENRO Mati'], 'mati' => ['cenro_mati', 'CENRO Mati'], 'mati_cenro' => ['cenro_mati', 'CENRO Mati'],
            'hamiguitan' => ['hamiguitan', 'Hamiguitan'], 'mhrws' => ['hamiguitan', 'Hamiguitan'],
        ...
        // Keep legacy stored labels readable while making their internal keys canonical.
        if (in_array($token, ['baganga', 'mati', 'hamiguitan', 'mhrws'], true)) {
            $canonical = $label;
        }
