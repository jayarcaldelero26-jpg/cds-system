import{s as e,t}from"./app-CeTzEOMr.js";e();var n=t();function r({show:e,onClose:t,title:r=`Success!`,message:i=`Action completed successfully.`}){return e?(0,n.jsxs)(`div`,{className:`fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/55 backdrop-blur-xs`,children:[(0,n.jsx)(`style`,{children:`
                @keyframes stroke {
