...
export default function CrudTable({ title, subtitle, helperText, headerAside, columns = [], rows = [], rowKey = 'id', onRowClick, isRowDisabled, loading = false, emptyTitle = 'No records found', emptyDescription, emptyStateClassName = '', preserveFrameWhenEmpty = false, selectable = false, selectedKeys = [], onSelectRow, onSelectAll, headerActions, filters, pagination, caption, className = '', tableClassName = '', tableContainerClassName = '', tableHeaderClassName = '', compact = false, compactEmpty = false }) {
    ...
    const showHeader = !compactEmpty || !empty || preserveFrameWhenEmpty;
    const showPagination = pagination && (!compactEmpty || !empty || preserveFrameWhenEmpty);
