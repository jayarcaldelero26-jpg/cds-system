                    ...
                    <form onSubmit={submit} className="space-y-6">
                        <div className="grid gap-6 md:grid-cols-2">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <textarea required rows="3" className={inputClass} value={data.issue_description} onChange={(e) => setData('issue_description', e.target.value)} />
                            ...
                            <div className="md:col-span-2">
                                ...
                                <textarea required rows="3" className={inputClass} value={data.findings} onChange={(e) => setData('findings', e.target.value)} />
                            ...
                            <div className="md:col-span-2">
                                ...
                                <textarea rows="3" className={inputClass} value={data.action_taken} onChange={(e) => setData('action_taken', e.target.value)} />
