...
export default function Dashboard({ view = 'pa', engp, rows, pagination, filterOptions, filters, summary, paMatrix, topOverdueReports, executiveInterpretation, actionQueue = [] }) {
    const { props } = usePage();
