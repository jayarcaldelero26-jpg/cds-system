                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
                            <div>
                                ...
                                <select
                                    ...
                                    className="rounded-xl border-gray-300 dark:border-gray-700 dark:bg-gray-800 text-xs px-3 py-2.5 font-medium w-full shadow-xs focus:ring-emerald-500 focus:border-emerald-500"
                                >
