...
export default function Create({ protectedAreas, reportTypes, statuses, quarters }) {
    ...
    return (
        <AuthenticatedLayout title="Add Technical Report">
            <PageHeader
                title="Add Technical Report"
                description="Record a new Assessment of Wetland Status (AWS) or other technical report submissions."
                actions={
                ...
                <Card>
                    <form onSubmit={submit} className="space-y-6">
                        <div className="grid gap-6 md:grid-cols-2">
                            ...
                            {/* Attachment Upload */}
                            <div>
                                <label className={labelClass}>Upload File (PDF Max 20MB)</label>
                                <input
                                    type="file"
