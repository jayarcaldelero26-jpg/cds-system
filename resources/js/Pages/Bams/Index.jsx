                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <select
                                                ...
                                                className="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-white rounded-xl text-xs"
                                                required
                                            >
                                                <option value="">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-white rounded-xl text-xs italic"
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-white rounded-xl text-sm"
                                        required
                                    >
                                        <option value="">
                                            Select Protected Area
