...
return new class extends Migration
{
    ...
    {
        Schema::create('imea_report_submissions', function (Blueprint $table): void {
            $table->id();
            ...
            $table->timestamps();
            $table->index(['semester', 'protected_area_id'], 'imea_reports_semester_pa_index');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('imea_report_submissions');
    }
};
