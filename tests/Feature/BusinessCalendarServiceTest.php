...
test('the same configured holiday is used by Standard A, Standard B, and days complied', function () {
    ...
    expect($standardA->deadline_submission)->toBe('2026-08-31')
        ->and($standardA->number_days_complied)->toBe(12)
        ->and($standardB->deadline_submission)->toBe('2026-08-17')
        ->and($standardB->number_days_complied)->toBe(6)
        ->and($calendar->workingDaysBetween('2026-08-03', '2026-08-25', 'after_through', null, BusinessCalendarService::CONSERVATION_WORKING_WEEKDAYS))->toBe(12);
});
